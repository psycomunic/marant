    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden py-20">
      ...
      <div className="container mx-auto px-6 relative z-10 flex flex-col lg:flex-row items-center gap-16">
        <div className="lg:w-3/5 text-center lg:text-left">
          <div className="inline-flex items-center gap-2 px-4 py-2 glass rounded-full text-blue-400 text-xs font-bold tracking-widest mb-8 animate-bounce">
          ...
          <div className="flex flex-col sm:flex-row gap-5 justify-center lg:justify-start">
            <button
              onClick={onCtaClick}
              className="bg-blue-600 text-white px-10 py-5 font-black flex items-center justify-center gap-3 hover:bg-blue-500 transition-all rounded-2xl shadow-[0_20px_40px_rgba(37,99,235,0.3)] hover:-translate-y-1"
            >
              INICIAR PROJETO <ArrowRight size={20} />
            </button>
            <button className="glass text-white px-10 py-5 font-black flex items-center justify-center gap-3 hover:bg-white/10 transition-all rounded-2xl">
        ...
        <div className="lg:w-2/5 relative flex justify-center">
          <div className="relative w-full max-w-md aspect-square">
            ...
            <div className="absolute inset-0 glass p-3 rounded-[40px] rotate-3 hover:rotate-0 transition-transform duration-700">
               <img 
            ...
            {/* Stats Card 1 */}
            <div className="absolute -top-10 -right-6 glass p-6 rounded-2xl shadow-2xl animate-float">
              <p className="text-4xl font-black text-blue-500">+250</p>
              <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Obras Entregues</p>
            </div>

            {/* Stats Card 2 */}
            <div className="absolute -bottom-6 -left-10 glass p-6 rounded-2xl shadow-2xl animate-float-delayed">
